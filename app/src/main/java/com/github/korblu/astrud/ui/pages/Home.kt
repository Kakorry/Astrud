...
fun AstrudDial() {
    ...
    val getFolder =
        (rememberLauncherForActivityResult(audioFiles.contractDocumentTree, audioFiles.onResult))
                            ...
                            modifier = Modifier
                                ...
                                .background(
                                    ...
                                    RoundedCornerShape(
                                        topStart = roundUnit1,
                                        topEnd = roundUnit2,
                                        bottomStart = roundUnit3,
                                        bottomEnd = roundUnit4
                                    )
                                )
                                .clickable(
                                    enabled = true,
                                    ...
                                    onClick = {
                                        if (click == 0) {
                                            ...
                                            bitmap =
                                                audioFiles.getEmbeddedPic(context)?.asImageBitmap()
                                                    ?: bitmap
                                        }
                                    }
                                ),
